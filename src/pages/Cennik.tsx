...
const Cennik = () => {
  ...
  const pricing = [
    ...
    { period: "14.06–28.06", price: "350 zł" },
    { period: "28.06–05.07", price: "450 zł" },
    { period: "05.07–12.07", price: "470 zł" },
    { period: "12.07–16.08", price: "550 zł" },
    { period: "16.08–31.08", price: "450 zł" },
